...
<body class="container">
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<a class="nav-item nav-link" href=".listpage">List Products</a>
			</div>
		</div>
	...
	<form class="row g-3" id="myForm" action="add.listpage">
		<div class="col-md-6">
		...
		<div class="col-md-6">
			<label for="productName" class="form-label"><b>Product
					Name:</b></label> <input type="text" class="form-control" id="productName"
				name="productName">
		</div>
		<div class="col-12">
		...
		<div class="col-12">
			...
			<textarea class="form-control" id="exampleFormControlTextarea1"
				rows="3" placeholder="Describe about the Product"
				name="productDescription"></textarea>
		</div>
		<div class="col-md-6">
			<label for="productPrice" class="form-label"><b>Product
					Price</b></label> <input type="text" class="form-control" id="productPrice"
				name="productPrice">
		</div>
		<div class="col-md-4">
			<label for="inStockProducts" class="form-label"><b>In
					Stock</b></label> <input type="text" class="form-control" id="inStock"
				name="inStock">
		</div>
		<div class="col-12">
