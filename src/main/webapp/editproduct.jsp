	...
	<form class="row g-3" id="myForm" action="edit.listpage">
		...
		<div class="col-12">
			<label for="productType" class="form-label"><b>Product
					Type:</b></label> <select class="form-select" name="productType"
				style="width: 400px;">
		...
		<div class="col-12">
			...
			<textarea class="form-control" id="exampleFormControlTextarea1"
				rows="3" name="productDescription">${product.getDescription()}</textarea>
		</div>
		<div class="col-md-6">
		...
		<div class="col-md-4">
			<label for="inStockProducts" class="form-label"><b>In
				...
				class="form-control" id="inStock" name="inStock">
		</div>
		<div class="col-12">
